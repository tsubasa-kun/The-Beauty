...
public class RoundImageView extends ImageView {
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        ...
        mBorderInsideThickness = a.getDimensionPixelSize(R.styleable.RoundImageView_border_inside_thickness, 0);
        mBorderOutsideThickness = a.getDimensionPixelSize(R.styleable.RoundImageView_border_outside_thickness, 0);
